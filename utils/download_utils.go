...
func DownloadFile(url string, dest string, checksum string) (string, error) {
	return downloadFileUtil(url, dest, checksum)
}

func downloadFileUtil(url string, dest string, checksum string) (string, error) {
